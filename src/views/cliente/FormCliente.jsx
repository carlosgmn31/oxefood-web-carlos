...
function salvar() {
       ...
       if (idCliente != null) { //Alteração:
           ...
           .then(response => { console.log('Cliente alterado com sucesso.',JSON.stringify(response,null,2))},setTimeout(navigate('/list-cliente?nocache=' + new Date().getTime())))
           .catch(error => { console.log('Erro ao alterar um cliente.',JSON.stringify(error,null,2)) })
       } else { //Cadastro:
           axios.post("http://localhost:8080/api/cliente", clienteRequest)
           .then((response) => { console.log('Cliente cadastrado com sucesso.',JSON.stringify(response,null,2)) },setTimeout(navigate('/list-cliente?nocache=' + new Date().getTime())))
